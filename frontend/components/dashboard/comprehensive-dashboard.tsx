    ...
    <div className="container mx-auto px-4 py-6 max-w-7xl">
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-1">
          <Card className="bg-gradient-to-br from-slate-800/50 to-slate-700/30 backdrop-blur-sm border border-slate-600/30 sticky top-6">
            <CardContent className="p-6">
              {/* Profile Header */}
              <div className="text-center mb-6">
                <Avatar className="w-24 h-24 mx-auto mb-4 ring-4 ring-cyan-500/20">
                ...
                <p className="text-gray-400 text-sm mb-3">{profileData.role}</p>
                <Badge className="bg-gradient-to-r from-cyan-500/20 to-blue-500/20 text-cyan-400 border-cyan-400/30">
              ...
              <div className="grid grid-cols-2 gap-3 mb-6">
                <div className="bg-slate-700/50 rounded-lg p-3 text-center">
                  <div className="text-2xl font-bold text-cyan-400">{totalSkills}</div>
                ...
                <div className="bg-slate-700/50 rounded-lg p-3 text-center">
                  <div className="text-2xl font-bold text-purple-400">{activeLearningPaths}</div>
                  <div className="text-xs text-gray-400">Active Paths</div>
                </div>
                <div className="bg-slate-700/50 rounded-lg p-3 text-center">
                  <div className="text-2xl font-bold text-amber-400">{Math.round(averageScore)}%</div>
