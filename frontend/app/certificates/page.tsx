...
export default function CertificatesPage() {
  ...
  const handleSendMessage = (message: string) => {
    console.log('Certificates chat message:', message)
    // TODO: Implement your chat logic here for certificate-related queries
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900/20 to-slate-800">
      ...
      <FloatingChatBar
        ...
        placeholder="Ask me about certification requirements, achievements, and credentials..."
        enableVoice={true}
        enableMinimize={true}
      />
    </div>
